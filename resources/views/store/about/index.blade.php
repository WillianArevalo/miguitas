    ...
    <div class="mt-8">
        ...
        <div class="mt-10">
            <div class="flex flex-col items-center justify-center gap-8 sm:flex-row">
                ...
                <div class="flex flex-1 flex-col gap-4 px-4 font-dine-r text-sm text-zinc-700 sm:pe-20 md:text-base">
                    <h1 class="font-pluto-r text-4xl font-bold text-blue-store">MIGUITAS</h1>
            ...
            <div class="mt-20 text-zinc-700">
                <div class="mx-auto flex w-full flex-col gap-4 px-4 font-dine-r text-sm sm:w-1/2 sm:px-0 md:text-base">
                ...
                <div class="mx-auto mt-10 w-full px-4 sm:w-4/5 md:w-3/5">
                    <h2 class="text-lg font-bold text-blue-store sm:text-xl md:text-2xl">
                    ...
                    <div class="mt-4 flex flex-col gap-2 sm:flex-row sm:gap-4 md:gap-8">
                        ...
                        <div class="flex flex-1 flex-col gap-4">
                            ...
                            <div
                                ...
                                <p class="font-dine-r">¿Tu peludo está por cumplir años? Nosotros te hacemos el pastel para
                                    que celebres con él, ¡naturalmente!
                                </p>
                            </div>
