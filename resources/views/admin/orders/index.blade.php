                ...
                <div class="relative bg-white dark:bg-black">
                    ...
                    <div
                        ...
                        <div class="w-full md:w-1/2">
                            <div class="flex items-center" action="{{ route('admin.categories.search') }}">
                                <x-input type="text" id="inputSearchOrders" name="inputSearchOrders"
                                    data-form="#formSearchOrders" data-table="#tableOrders" placeholder="Buscar"
                        ...
                        <div
                            ...
                            <div class="w-full md:w-52">
                                <x-select label="" name="filter-status-orders" id="filter-status-orders"
                                    :options="[
